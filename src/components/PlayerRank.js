...
export default class PlayerRank extends Component {
    ...
    ifEmpty() {
        if (this.state.emptyRanked === true) {
            return <p className="no-ranked">No Ranked Games Available</p>
        }
    }
    ...
    checkItem(item) {
        if (item !== "") {
            ...
            return <img src={require('../img/icon/item.png')} alt="smite empty item" />
        }
    }
                        ...
                        <div>
                            <div className="match">
                                ...
                                <div className="ownPlayer">
                                    ...
                                    <img src={`https://web2.hirez.com/smite/god-icons/${this.state.match1Player[0].Reference_Name.toLowerCase().replace(/'/g, "").replace(/ /g, "-")}.jpg`} className="history-god-img" alt="smite gods" />
                                    ...
                                    <div className="items">
                                        ...
                                        <div className="relics">
                                            ...
                                            <img src={`https://web2.hirez.com/smite/item-icons/${this.state.match1Player[0].Item_Active_2.toLowerCase().replace(/'/g, "").replace(/ /g, "-")}.jpg`} alt="smite relics" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="match">
                                <div className="ownPlayer">
                                    ...
                                    <div className="items">
                                        ...
                                        <div className="relics">
                                            <img src={`https://web2.hirez.com/smite/item-icons/${this.state.match3Player[0].Item_Active_1.toLowerCase().replace(/'/g, "").replace(/ /g, "-")}.jpg`} alt="smite relics" />
                                            <img src={`https://web2.hirez.com/smite/item-icons/${this.state.match3Player[0].Item_Active_2.toLowerCase().replace(/'/g, "").replace(/ /g, "-")}.jpg`} alt="smite relics" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="ownPlayer">
                                    ...
                                    <div className="items">
                                        ...
                                        <div className="relics">
                                            ...
                                            <img src={`https://web2.hirez.com/smite/item-icons/${this.state.match5Player[0].Item_Active_2.toLowerCase().replace(/'/g, "").replace(/ /g, "-")}.jpg`} alt="smite relics" />
                                        </div>
                                    </div>
                                </div>
